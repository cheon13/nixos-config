...
{
  xdg.configFile."river/scripts" = {
    source = config.lib.file.mkOutOfStoreSymlink "${config.home.homeDirectory}/.dotfiles/modules/home-manager/config/river/scripts";
    #recursive = true;
  };
  ...
  wayland.windowManager.river = {
    ...
    extraConfig = ''
      ...
      riverctl map normal Alt R spawn '~/.config/river/scripts/reseau.sh'
      riverctl map normal Mod5 R spawn '~/.config/river/scripts/reseau.sh'
