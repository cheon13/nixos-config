#+TITLE: Notes de mise à jour — 14 octobre 2024
#+OPTIONS: toc:nil num:nil

Lundi 14 octobre 2024, 14:00 EDT.

En résumé : la mise à jour casse la compilation de =dwl=, qui ne trouve plus
=wlroots= via pkg-config. Deux options obsolètes sont également signalées
(~sound~ et ~hardware.opengl.driSupport~), ainsi que le passage de taskwarrior
2.6 à 3.
