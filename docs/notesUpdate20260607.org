#+TITLE: Notes de mise à jour — 7 juin 2026
#+OPTIONS: toc:nil num:nil

Dimanche 7 juin 2026.

En résumé : =hash mismatch= sur la source du greffon =claudecode-nvim=, qui fait
tomber en cascade neovim, nixvim, puis toute la génération home-manager. Deux
avertissements sans rapport : le =follows= sur l'entrée nixpkgs de nixvim, et
=nixfmt-rfc-style= désormais identique à =pkgs.nixfmt=.
